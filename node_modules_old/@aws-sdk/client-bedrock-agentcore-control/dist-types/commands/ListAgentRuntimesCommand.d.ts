...
declare const ListAgentRuntimesCommand_base: {
    new (input: ListAgentRuntimesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentRuntimesCommandInput, ListAgentRuntimesCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAgentRuntimesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListAgentRuntimesCommandInput, ListAgentRuntimesCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAgentRuntimesCommand extends ListAgentRuntimesCommand_base {
