...
declare const DeleteCodeInterpreterCommand_base: {
    new (input: DeleteCodeInterpreterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteCodeInterpreterCommandInput, DeleteCodeInterpreterCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteCodeInterpreterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteCodeInterpreterCommandInput, DeleteCodeInterpreterCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteCodeInterpreterCommand extends DeleteCodeInterpreterCommand_base {
