...
declare const DeleteApiKeyCredentialProviderCommand_base: {
    new (input: DeleteApiKeyCredentialProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApiKeyCredentialProviderCommandInput, DeleteApiKeyCredentialProviderCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteApiKeyCredentialProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApiKeyCredentialProviderCommandInput, DeleteApiKeyCredentialProviderCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteApiKeyCredentialProviderCommand extends DeleteApiKeyCredentialProviderCommand_base {
