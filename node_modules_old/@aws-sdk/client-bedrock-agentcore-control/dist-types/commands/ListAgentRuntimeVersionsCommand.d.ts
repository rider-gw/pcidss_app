...
declare const ListAgentRuntimeVersionsCommand_base: {
    new (input: ListAgentRuntimeVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentRuntimeVersionsCommandInput, ListAgentRuntimeVersionsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAgentRuntimeVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentRuntimeVersionsCommandInput, ListAgentRuntimeVersionsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAgentRuntimeVersionsCommand extends ListAgentRuntimeVersionsCommand_base {
