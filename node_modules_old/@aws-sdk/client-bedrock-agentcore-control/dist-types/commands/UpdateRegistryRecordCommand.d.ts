...
declare const UpdateRegistryRecordCommand_base: {
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
