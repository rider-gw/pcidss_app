...
declare const ListBrowsersCommand_base: {
    new (input: ListBrowsersCommandInput): import("@smithy/smithy-client").CommandImpl<ListBrowsersCommandInput, ListBrowsersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListBrowsersCommandInput]): import("@smithy/smithy-client").CommandImpl<ListBrowsersCommandInput, ListBrowsersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListBrowsersCommand extends ListBrowsersCommand_base {
