...
declare const ListApiKeyCredentialProvidersCommand_base: {
    new (input: ListApiKeyCredentialProvidersCommandInput): import("@smithy/smithy-client").CommandImpl<ListApiKeyCredentialProvidersCommandInput, ListApiKeyCredentialProvidersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListApiKeyCredentialProvidersCommandInput]): import("@smithy/smithy-client").CommandImpl<ListApiKeyCredentialProvidersCommandInput, ListApiKeyCredentialProvidersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListApiKeyCredentialProvidersCommand extends ListApiKeyCredentialProvidersCommand_base {
