...
declare const ListCodeInterpretersCommand_base: {
    new (input: ListCodeInterpretersCommandInput): import("@smithy/smithy-client").CommandImpl<ListCodeInterpretersCommandInput, ListCodeInterpretersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListCodeInterpretersCommandInput]): import("@smithy/smithy-client").CommandImpl<ListCodeInterpretersCommandInput, ListCodeInterpretersCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListCodeInterpretersCommand extends ListCodeInterpretersCommand_base {
