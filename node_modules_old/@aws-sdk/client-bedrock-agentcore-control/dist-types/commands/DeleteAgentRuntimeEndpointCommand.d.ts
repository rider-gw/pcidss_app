...
declare const DeleteAgentRuntimeEndpointCommand_base: {
    new (input: DeleteAgentRuntimeEndpointCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentRuntimeEndpointCommandInput, DeleteAgentRuntimeEndpointCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteAgentRuntimeEndpointCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentRuntimeEndpointCommandInput, DeleteAgentRuntimeEndpointCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAgentRuntimeEndpointCommand extends DeleteAgentRuntimeEndpointCommand_base {
