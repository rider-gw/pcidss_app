...
declare const GetApiKeyCredentialProviderCommand_base: {
    new (input: GetApiKeyCredentialProviderCommandInput): import("@smithy/smithy-client").CommandImpl<GetApiKeyCredentialProviderCommandInput, GetApiKeyCredentialProviderCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetApiKeyCredentialProviderCommandInput): import("@smithy/smithy-client").CommandImpl<GetApiKeyCredentialProviderCommandInput, GetApiKeyCredentialProviderCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
