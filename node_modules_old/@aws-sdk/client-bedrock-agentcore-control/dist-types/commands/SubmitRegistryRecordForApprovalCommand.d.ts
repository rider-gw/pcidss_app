...
import type { SubmitRegistryRecordForApprovalRequest, SubmitRegistryRecordForApprovalResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const SubmitRegistryRecordForApprovalCommand_base: {
    new (input: SubmitRegistryRecordForApprovalCommandInput): import("@smithy/smithy-client").CommandImpl<SubmitRegistryRecordForApprovalCommandInput, SubmitRegistryRecordForApprovalCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SubmitRegistryRecordForApprovalCommandInput): import("@smithy/smithy-client").CommandImpl<SubmitRegistryRecordForApprovalCommandInput, SubmitRegistryRecordForApprovalCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
