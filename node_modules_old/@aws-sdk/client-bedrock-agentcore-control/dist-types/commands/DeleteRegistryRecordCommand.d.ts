...
declare const DeleteRegistryRecordCommand_base: {
    new (input: DeleteRegistryRecordCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRegistryRecordCommandInput, DeleteRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteRegistryRecordCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRegistryRecordCommandInput, DeleteRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
