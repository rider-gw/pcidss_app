...
declare const CreateWorkloadIdentityCommand_base: {
    new (input: CreateWorkloadIdentityCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorkloadIdentityCommandInput, CreateWorkloadIdentityCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateWorkloadIdentityCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorkloadIdentityCommandInput, CreateWorkloadIdentityCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateWorkloadIdentityCommand extends CreateWorkloadIdentityCommand_base {
