...
declare const DeleteAgentRuntimeCommand_base: {
    new (input: DeleteAgentRuntimeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentRuntimeCommandInput, DeleteAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteAgentRuntimeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentRuntimeCommandInput, DeleteAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAgentRuntimeCommand extends DeleteAgentRuntimeCommand_base {
